### Streamlit应用程序开发
#参考文章 https://mp.weixin.qq.com/s/zbh0xSiY6CUW0_skXN_zrg
...
# Load the model
#加载保存的GBoost.pkl' 的文件，以便后续加载和使用，以此部署APP

path = 'E:/砥脊科技/项目交付/郭慧琴-小细胞肺癌/项目1-小细胞肺癌肿瘤分类AI模型/SCLC_NSCLC/AI模型训练/feature_top10/'

model_path = os.path.join(path, 'model_186/MODEL_2024_12_18_17_53_24.h5')
